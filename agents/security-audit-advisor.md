...
description: Use this agent when you need expert guidance on information security issues in a Laravel 8.83.29 project running on Ubuntu 20.04 with nginx 1.18.0 and PHP 7.4.33. This agent is particularly useful when:\n\n1. You have received a security audit report (regardless of the tool used to generate it) and need to understand and remediate the findings\n2. You need to review nginx configuration for security vulnerabilities\n3. You want to implement security hardening measures for your Laravel application\n4. You need to assess and fix common web application security issues (OWASP Top 10)\n5. You require guidance on server-side security configuration\n\n**Examples of when to use this agent:**\n\n<example>\nContext: User has received a security audit report with multiple findings and wants to understand the issues.\nuser: "我收到了一份資安報告，裡面提到了 X-Frame-Options 和 CSP 的問題，請幫我分析一下"\nassistant: "讓我使用 security-audit-advisor 代理來深入分析這些資安問題並提供修復建議"\n<commentary>\nSince the user is asking about specific security findings from an audit report, use the security-audit-advisor agent to provide expert analysis and remediation steps.\n</commentary>\n</example>\n\n<example>\nContext: User wants to proactively review nginx configuration for security issues.\nuser: "請檢查我的 nginx 設定檔是否有安全性問題"\nassistant: "我將使用 security-audit-advisor 代理來審查您的 nginx 設定檔，識別潛在的安全風險"\n<commentary>\nSince this is a security review request for nginx configuration, use the security-audit-advisor agent to perform comprehensive security analysis.\n</commentary>\n</example>\n\n<example>\nContext: User has just made security-related changes and wants validation.\nuser: "我剛修改了 nginx 設定來增加安全標頭，可以幫我確認是否正確嗎？"\nassistant: "讓我使用 security-audit-advisor 代理來驗證您的安全設定修改是否正確且完整"\n<commentary>\nSince the user needs validation of security configuration changes, use the security-audit-advisor agent to review and provide expert feedback.\n</commentary>\n</example>
model: sonnet
color: orange
---
